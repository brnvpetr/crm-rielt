    ...
    <section class="news">
            <div class="container">
                    ...
                    <div class="my-3 p-3 bg-white rounded shadow-sm">
                            <h6 class="border-bottom border-gray pb-2 mb-0">Свежие новости</h6>
                  ...
                  <div>
                    <br>
                    <form action="services/news/updateNews.php" method="POST">
                    <p><h3><textarea wrap="soft | hard" cols="50%" rows="5%" name="textnews"><?= $textnews ?></textarea><h3></p>
                            <button class="btn btn-primary btn-sm" type="submit">Сохранить</button>
                    </form>
                            <form action='services/news/delete.php' method='POST'>
                            <input class='form-check-input' type='text' name='news_id' value="<?= $id ?>" hidden>
                ...
                <div class="modal-body">
                        <form action="/acction_news.php">
                            <div class="form-group">
                              ...
                              <fieldset>
                              <textarea name="textnews" type="tex" class="form-control" id="phone" wrap="soft | hard" cols="50" rows="5"></textarea>
                              </fieldset>
                            </div>

            ...
            <div class="container">
                ...
                <table class="table table-hover">
                    ...
                    while ($a = mysql_fetch_assoc($result)) {
                        ...
                        $plandoovorov = $a['plandogovorov'];
                        $passworduser = $a['password'];
                        $loginuser = $a['login'];
                        ...
                        ?>
                  <tbody>
                      <form action="services/clients/updateUsers.php" method="POST">
                    <tr>
                    <td><?= $fiouser ?></td>
                    <td><?= $loginuser ?></td>
                    <td><?= $passworduser ?></td>
                    ...
                    <td><?= $emailuser ?></td>
                    <td>
                    <input type="text" name="procentzarplata" value="<?= $procentzarplata ?>"></td>
                    <td><?= $plandoovorov ?></td>
                    <td>

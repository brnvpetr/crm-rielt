  ...
  <body>
    ...
    <section class="ads">
      <div class="container">
        <h2>Объявления</h2>
        <p>
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#news1">Добавить</button>
        </p>
        <form action='action_ads.php' method='POST'>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="/action_ads.php">
                <div class="form-group">
                  <label for="usermanager">Менеджер:</label>
                  <input name="fioads" type="text" class="form-control" id="manageruserus" value="<?php echo $_SESSION['fiouser']; ?>">
                </div>
                <div class="form-group">
                  <label for="usermanager">Область, город:</label>
                  <input name="cityads" type="text" class="form-control" id="manageruserus">
                </div>
                <div class="form-group">
                  <div class="form-group">
                    <label for="usermanager">Адресс:</label>
                    <input name="adressads" type="text" class="form-control" id="manageruserus">
                  </div>
                  <div class="form-group">
                    <label for="siteads">Ссылка:</label>
                    <input name="siteads" type="url" class="form-control" id="siteads">
                  </div>
